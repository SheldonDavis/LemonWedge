  ...
  return /*#__PURE__*/_jsxs(Html, {
    children: [/*#__PURE__*/_jsx(Head, {}), /*#__PURE__*/_jsx(Tailwind, {
      children: /*#__PURE__*/_jsx(Body, {
        className: "bg-white my-12 mx-auto font-sans",
        children: /*#__PURE__*/_jsxs(Container, {
          ...
          children: [/*#__PURE__*/_jsx(Heading, {
            ...
            className: "text-lg font-medium text-grey-700",
            children: "Thanks for joining LemonWedge"
          }), /*#__PURE__*/_jsx(Button, {
            className: "bg-purple-700 text-white font-bold px-6 py-4 rounded-md",
            href: "#",
            children: "Google"
          })]
        })
